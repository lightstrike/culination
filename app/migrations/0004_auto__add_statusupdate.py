...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_statusupdate', (
            ('page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
            ('header_copy', self.gf('django.db.models.fields.CharField')(max_length=126)),
            ('title_copy', self.gf('django.db.models.fields.CharField')(max_length=126)),
            ('message', self.gf('mezzanine.core.fields.RichTextField')()),
        ))
        db.send_create_signal('app', ['StatusUpdate'])

    def backwards(self, orm):
        # Deleting model 'StatusUpdate'
        db.delete_table('app_statusupdate')
    ...
    models = {
        ...
        'app.statusupdate': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'StatusUpdate', '_ormbases': ['pages.Page']},
            'header_copy': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'message': ('mezzanine.core.fields.RichTextField', [], {}),
            'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'title_copy': ('django.db.models.fields.CharField', [], {'max_length': '126'})
        },
        'app.step': {
