...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PressTeamBlock'
        db.create_table('app_pressteamblock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('press', self.gf('django.db.models.fields.related.ForeignKey')(related_name='team_blocks', to=orm['app.Press'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=126)),
            ('link', self.gf('django.db.models.fields.CharField')(max_length=126)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=126)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=126)),
        ))
        db.send_create_signal('app', ['PressTeamBlock'])

        # Adding model 'Press'
        db.create_table('app_press', (
            ('page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
            ('release_copy', self.gf('django.db.models.fields.CharField')(max_length=126)),
            ('release_link', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('about_copy', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('photo_link', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('expert_copy', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('product_copy', self.gf('mezzanine.core.fields.RichTextField')()),
        ))
        db.send_create_signal('app', ['Press'])

        # Adding model 'PressTestimonialBlock'
        db.create_table('app_presstestimonialblock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('press', self.gf('django.db.models.fields.related.ForeignKey')(related_name='testimonial_blocks', to=orm['app.Press'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=126)),
            ('description', self.gf('mezzanine.core.fields.RichTextField')()),
        ))
        db.send_create_signal('app', ['PressTestimonialBlock'])

        # Adding model 'PressPartnerBlock'
        db.create_table('app_presspartnerblock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('press', self.gf('django.db.models.fields.related.ForeignKey')(related_name='partner_blocks', to=orm['app.Press'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=126)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('link', self.gf('django.db.models.fields.CharField')(max_length=126)),
        ))
        db.send_create_signal('app', ['PressPartnerBlock'])

        # Adding model 'PressLinkBlock'
        db.create_table('app_presslinkblock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('press', self.gf('django.db.models.fields.related.ForeignKey')(related_name='link_blocks', to=orm['app.Press'])),
        ...
        db.send_create_signal('app', ['PressLinkBlock'])

        # Adding model 'PressExpertBlock'
        db.create_table('app_pressexpertblock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('press', self.gf('django.db.models.fields.related.ForeignKey')(related_name='expert_blocks', to=orm['app.Press'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=126)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('link', self.gf('django.db.models.fields.CharField')(max_length=126)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=126)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=512)),
        ))
        db.send_create_signal('app', ['PressExpertBlock'])

        # Adding field 'HomeBlock.image'
        db.add_column('app_homeblock', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='http://culination.co/static/img/culination-logo-full.png', max_length=100),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'PressTeamBlock'
        db.delete_table('app_pressteamblock')

        # Deleting model 'Press'
        db.delete_table('app_press')

        # Deleting model 'PressTestimonialBlock'
        db.delete_table('app_presstestimonialblock')

        # Deleting model 'PressPartnerBlock'
        db.delete_table('app_presspartnerblock')

        # Deleting model 'PressLinkBlock'
        db.delete_table('app_presslinkblock')

        # Deleting model 'PressExpertBlock'
        db.delete_table('app_pressexpertblock')

        # Deleting field 'HomeBlock.image'
        db.delete_column('app_homeblock', 'image')
    ...
    models = {
        ...
        'app.press': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Press', '_ormbases': ['pages.Page']},
            'about_copy': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'expert_copy': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['pages.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'photo_link': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'product_copy': ('mezzanine.core.fields.RichTextField', [], {}),
            'release_copy': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'release_link': ('django.db.models.fields.CharField', [], {'max_length': '512'})
        },
        'app.pressexpertblock': {
            'Meta': {'object_name': 'PressExpertBlock'},
            'city': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'press': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'expert_blocks'", 'to': "orm['app.Press']"}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'app.presslinkblock': {
            'Meta': {'object_name': 'PressLinkBlock'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link_copy': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'link_target': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'press': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'link_blocks'", 'to': "orm['app.Press']"}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'app.presspartnerblock': {
            'Meta': {'object_name': 'PressPartnerBlock'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'press': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'partner_blocks'", 'to': "orm['app.Press']"}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'app.pressteamblock': {
            'Meta': {'object_name': 'PressTeamBlock'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'press': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'team_blocks'", 'to': "orm['app.Press']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'app.presstestimonialblock': {
            'Meta': {'object_name': 'PressTestimonialBlock'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('mezzanine.core.fields.RichTextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '126'}),
            'press': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'testimonial_blocks'", 'to': "orm['app.Press']"}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'app.profile': {
        ...
        'app.usersignuprequest': {
            'Meta': {'object_name': 'UserSignupRequest'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '256'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
